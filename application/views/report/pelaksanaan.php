    ...
    <div class="wrapper">
      ...
      <section class="invoice">
		...
		<div class="row">
			...
			<h4><b><u>PENETAPAN PELAKSANA PEKERJAAN</u></b></h4>
			<?php echo $row->no; ?><br>
			</div><!-- /.col -->
			<?php
		...
		<div class="row">
			...
			<div class="col-xs-9">
				...
				<p class="text-justify">      
					Berdasarkan Berita Acara Evaluasi Penawaran serta Klarifikasi dan Negoisasi Teknis dan Harga No : 
					<?php echo $u->no; ?> tanggal <?php echo date("d",strtotime($u->tgl))." ".bulan($u->tgl)." ".date("Y",strtotime($u->tgl)); ?>, 
					selaku Pejabat Pengadaan Barang dan Jasa, membuat Surat Penetapan Pemenang 
					<?php echo $u->pengadaan; ?> untuk Kegiatan <?php echo $u->kegiatan; ?> Tahun <?php echo date("Y",strtotime($u->tgl)); ?> adalah sebagai berikut :
				</p>
				...
				<p class="text-justify">
				        Demikian Penetapan ini dibuat untuk dipergunakan sebagai dasar proses lebih lanjut.
				</p>
			</div><!-- /.col -->
			<div class="col-xs-1">
			</div><!-- /.col -->
